...
- (void)viewDidLoad {
    ...
    self.tabBar.backgroundColor = [UIColor LKColorWithLightHex:@"#F1F1F1" darkHex:@"#F1F1F1"];
    self.tabBar.backgroundImage = [UIImage new];
    self.tabBar.tintColor = [UIColor blueColor];
    self.tabBar.barTintColor = [UIColor blueColor];
    self.tabBar.unselectedItemTintColor = [UIColor LKColorWithLightHex:@"#3a3a3a" darkHex:@"#3a3a3a"];
