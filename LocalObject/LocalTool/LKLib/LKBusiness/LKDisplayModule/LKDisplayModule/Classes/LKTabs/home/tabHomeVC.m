...
- (NSArray<Item *> *)mockPlayerDemoItems {
    return @[
        ...
        [Item.alloc initWithTitle:@"hello swift JK"
                         subTitle:@"show iconFont Book"
                               vc:[JKTestVC new]],
        [Item.alloc initWithTitle:@"hello Banner"
                         subTitle:@"show Banner"
                               vc:[showBannerVC new]],
        [Item.alloc initWithTitle:@"hello editCell"
                         subTitle:@"show EditList"
                               vc:[showEditTableVC new]],
        [Item.alloc initWithTitle:@"hello 匹配一下"
                         subTitle:@"show showComplareVC"
                               vc:[showComplareVC new]],
        [Item.alloc initWithTitle:@"hello 卡片"
                         subTitle:@"show showCardsTestVC"
                               vc:[showCardsTestVC new]],
        [Item.alloc initWithTitle:@"富文本"
                         subTitle:@"show YYTextDemo1ViewController"
                               vc:[YYTextDemo1ViewController new]]
