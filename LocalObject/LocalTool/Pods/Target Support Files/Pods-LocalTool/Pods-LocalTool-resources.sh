...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/LKDisplayModule/LKDisplayBundle.bundle"
  install_resource "${PODS_ROOT}/../LKLib/LKBusiness/LKGlobalization/LKGlobalization/Resources/LKLocalizable.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/LKIconFontKit/LKIconFontKit.bundle"
